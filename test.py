...
def compute_accuracy(feature_dict, pair_list, test_root):
    ...
    for pair in pairs:
        ...
        img1 = osp.join(test_root, img1).replace("images\\", "")
        img2 = osp.join(test_root, img2).replace("images\\", "")
...
if __name__ == '__main__':
    ...
    images = [osp.join(conf.test_root, img).replace("images\\", "") for img in images]
    ...
    # print(accuracy),print(threshold)
    print(
